...
int check=0;
		...
		<form name="loginform" action="/daum_api_signin/login_chk.jsp" method="post">
			<center>
				<table style="margin-top:20px;">
					<tr>
						...
						<button><a href ="/daum_api_signin/agree.jsp" class="hover">회원가입</a></button>  <!-- 회원가입을 누르면 a태그를 통해서 joinForm으로 이동한다. -->
						</td>
					</tr>
				</table>
			</center>
			...
			<a href="ologin.html">userid</a> or <a href="findpw.jsp">password</a></span>
            <%
        } 
		...
		<table style="margin-top:20px;" >	
		<form name="logoutform" action="/daum_api_signin/logout.jsp" method="post">
			<tr>
