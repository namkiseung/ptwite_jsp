...
<div id="container">
	...
	<table summary="글쓰기 전체 테이블">
		<form name="BoardWriteForm" method="post" action="http://192.168.56.1:8080/qna/Qna_Write_action.jsp" enctype="Multipart/form-data">
		...
		<caption>게시판 글쓰기</caption>	
    		...
    		<tr>
         		...
         		<input type="button" value="뒤로" onclick="move('Qna_List.jsp');"></div>
     			</td>
    		</tr> 
		</table>
	</form> 
