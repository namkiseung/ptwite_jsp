...
<%
    ...
    String uploadPath = request.getRealPath("/pure_fileupload");
...
<form action="fileCheck.jsp" method="post" name="fileCheckFormName">
    ...
    <input type="text" value="<%=fileName1%>" name="fileName1" />
    <input type="text" value="<%=originalName1%>" name="originalName1" />
</form>
