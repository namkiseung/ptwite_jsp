...
<form name="id_search" action="./3.levelup_confirm.jsp" method="get">
<center>
관리자 전용 :: 권한 수정 페이지(확인창)<br><br><br><br>
ID <input name="id" type="text" value="">
<input type="submit" value="검색"><p>
</form>
<form id="levelup" name="levelup" action="./3.levelup_confirm_Process.jsp" method="get" onsubmit="return cofirmCheck()">
<input name="rid" type="hidden" value="">
<input name="confirm" type="hidden" value="click_ok">
...
<script>
function cofirmCheck() {
if (confirm("정말 권한을 변경하시겠습니까??") == true){ //확인
}else{ //취소
return false;
}
}
