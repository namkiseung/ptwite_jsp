...
<form name="id_search" action="./2.levelup_post.jsp" method="post">
<center>
관리자 전용 :: 권한 수정 페이지(POST)<br><br><br><br>
ID <input name="id" type="text" value="">
<input type="submit" value="검색"><p>
</form>
<form id="levelup" name="levelup" action="./2.levelup_post_Process.jsp" method="post">
