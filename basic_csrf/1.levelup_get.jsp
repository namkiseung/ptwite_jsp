...
<form name="id_search" action="./1.levelup_get.jsp" method="get">
<center>
관리자 전용 :: 권한 수정 페이지(GET)<br><br><br><br>
ID <input name="id" type="text" value="">
<input type="submit" value="검색"><p>
</form>
<form id="levelup" name="levelup" action="./1.levelup_get_Process.jsp" method="get">
