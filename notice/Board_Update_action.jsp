...
<%	 
     ...
     try{
       ...
       Statement st = conn.createStatement();
		...
		String sql="UPDATE noticeboard SET attachB='"+req_attach+"', titleB='"+req_title+"', contentB='"+req_content+"', dateB=to_char(sysdate, \'YYYY-MM-DD HH:MI:SS\') where idxB="+req_num;
