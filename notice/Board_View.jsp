...
<%	 
     ...
     try{
       ...
       String sql = "select * from noticeboard where idxB="+data_num;
	   String sql_plusHit = "update noticeboard set hitB = (select hitB+1 from noticeboard where idxB="+data_num+") where idxB="+data_num;
	   st.execute(sql_plusHit);
       rs = st.executeQuery(sql);      
%>
	<form name="BoardViewForm" method="post" action="Board_Write_action.jsp">
    ...
    <tr>
		...
		<td bgcolor=#ffffe8><a id="downA" href="http://1192.168.177.136:8080/notice/Board_fileDown.jsp?file_name=<%=attach %>"><%=attach %></a></td> <!-- <a href="http://namkisec.tistory.com" target="_new">http://namkisec.tistory.com</a> -->
	</tr>
	<tr> 
