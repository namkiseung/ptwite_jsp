	...
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
			...
			<script>
				...
				form.setAttribute("action", "Board_Update_action.jsp");
								...
								<%@ include file="../left.jsp"%>
									...
									<div id="content">
										<table summary="글수정 전체 테이블">
											<form name="BoardUpdateForm" method="post" action="Board_Update_action.jsp">
																						...
																						<td>
																							...
																							<tr>
																								...
																								<tr>
																									...
																									<tr>
																										<td>비밀번호</td> 
																											<input id="__pw" type="password" name="password" value="" size=15 maxlength=15>
																										<td>
																														...
																														<div align="center">
																															<input type="submit" value="수정 완료" onclick="update_move();"> &nbsp;&nbsp;
																																<input type=reset value="다시 수정"> 
																																	<input type="button" value="뒤로" onclick="javascript:location.href='Board_List.jsp';">
																																	</div>
																																</td>
																															</tr> 
																														</table>
