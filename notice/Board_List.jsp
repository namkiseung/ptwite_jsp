     ...
     try{
	   ...
	   if(request.getParameter("col") != null && request.getParameter("word") != null){
		  ...
		  if(subject_search.equals("name")){ 
			...
			sql="select idxb, titleb, writerb, emailb, contentb, passb, hitb, attachb, dateb from (select idxb, titleb, writerb, emailb, contentb, passb, hitb, attachb, dateb, rownum rnum from noticeboard) where rnum > "+_start+" and rnum <= "+_end+" order by 1 desc";
	   }
	   //out.println(sql);
